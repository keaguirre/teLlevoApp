...
describe('PerfilConductorPage', () => {
  ...
  beforeEach(() => {
    ...
    const adminUsuariosServiceStub = () => ({
      obtenerConductorLogin: user => ({ then: () => ({}) }),
      updateConductor: (arg, value) => ({}),
      deleteConductor: user => ({ then: () => ({}) })
    });
    ...
    spyOn(PerfilConductorPage.prototype, 'cargarAvatar');
  ...
  describe('constructor', () => {
    it('makes expected calls', () => {
      expect(PerfilConductorPage.prototype.cargarAvatar).toHaveBeenCalled();
    });
  });
  ...
  describe('onLoadUsr', () => {
    it('makes expected calls', () => {
      ...
      spyOn(
        adminUsuariosServiceStub,
        'obtenerConductorLogin'
      ).and.callThrough();
      component.onLoadUsr();
      expect(component.onLoadForm).toHaveBeenCalled();
      expect(adminUsuariosServiceStub.obtenerConductorLogin).toHaveBeenCalled();
    });
  });
  ...
  describe('onUpdate', () => {
    it('makes expected calls', () => {
      ...
      spyOn(adminUsuariosServiceStub, 'updateConductor').and.callThrough();
      component.onUpdate();
      expect(component.alertPresent).toHaveBeenCalled();
      expect(modalControllerStub.dismiss).toHaveBeenCalled();
      expect(adminUsuariosServiceStub.updateConductor).toHaveBeenCalled();
    });
  });
  ...
  describe('mostrarAlertaEliminarUsuario', () => {
    it('makes expected calls', () => {
      ...
      spyOn(adminUsuariosServiceStub, 'deleteConductor').and.callThrough();
      spyOn(routerStub, 'navigateByUrl').and.callThrough();
      component.mostrarAlertaEliminarUsuario();
      expect(alertControllerStub.create).toHaveBeenCalled();
      expect(adminUsuariosServiceStub.deleteConductor).toHaveBeenCalled();
